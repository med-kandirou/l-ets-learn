<template>
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 h-screen bg-[url('https://www.filepicker.io/api/file/mQLwC8UTUiyjsDnRRBgN')] bg-no-repeat bg-center bg-cover bg-fixed">
        <div>
            <h1 class="mb-4 text-6xl font-bold leading-none text-white dark:text-white">WordPress avancé: maîtrisez les fonctionnalités avancées du CMS Wordpress</h1>
            <p class="mb-8 text-lg font-normal text-white lg:text-2xl sm:px-16 xl:px-48 dark:text-gray-400">Créez des sites Web complexes avec WordPress</p>
