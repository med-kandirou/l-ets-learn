<template>
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 h-auto bg-[url('https://www.filepicker.io/api/file/mQLwC8UTUiyjsDnRRBgN')] bg-no-repeat bg-center bg-cover bg-fixed">
        <div>
            ...
            <p class="mb-8 text-lg font-normal text-white lg:text-2xl sm:px-16 xl:px-48 dark:text-gray-400">{{course.cour.subtitle}}</p>
    ...
    <cardFormateur :nom="course.formateur.nom"  :prenom="course.formateur.prenom"  :email="course.formateur.email" :tele="course.formateur.tele" :description="course.formateur.description" />
    <Footer />
</template>
